 ...
 */
public class ScreeningCloseEnded extends Fragment implements View.OnClickListener {
    ...
    public static ScreeningCloseEnded newInstance(int sectionNumber, int catID) {

        ScreeningCloseEnded  fragment = new ScreeningCloseEnded ();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView= inflater.inflate(R.layout.fragment_screening_close_ended, container, false);
    ...
    private void setTitle()
    {
        ...
        switch (catId){
            case 1: title ="Oral Health Assessment"; break;
            case 2: title ="Hearing Health Assessment"; break;
            case 3: title ="Vision Health Assessment"; break;
    ...
    public void getAnswer ()
    {
        ...
        if(radrefyes.isChecked())
        {
            ...
            conQuiz.setQuizzReferral(new Referral(true, referee, dref, dfoll, conQuiz.getQuizzedPupil().getId(), CAT_ID ));
        }else{
            ...
            conQuiz.setQuizzReferral(new Referral(false, "No Referral", dref, dfoll, conQuiz.getQuizzedPupil().getId(), CAT_ID ));
