...
import ansteph.cct.healthscreener.slidingmenu.adapter.SlidingTabLayout;
...
public class Report extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //setting the color for the tabs
    ...
    private List<Fragment> getFragments() {
        ...
        flist.add(CaseManagement.newInstance(1));
        flist.add(PupilAssessed.newInstance(2));
        return flist;
    }
    /**
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
          ...
          return  Fragments.get(position);
           // return CaseManagement.newInstance(position + 1);
        }
